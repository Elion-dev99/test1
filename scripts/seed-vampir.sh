...
# --- ワールドボス 12:00 ---
WB12=(
  'ラルヴァ|Lv.47|ワールドボス（12:00）|フィールド固定位置・安全エリア付近|#3498DB'
  'クラマムス|Lv.70|ワールドボス（12:00）|フィールド固定位置|#2980B9'
  'エクセサ|Lv.95|ワールドボス（12:00）|フィールド固定位置|#1ABC9C'
)
...
# --- ワールドボス 20:00 ---
WB20=(
  'ブラーキウム|Lv.63|ワールドボス（20:00）|フィールド固定位置|#9B59B6'
  'デセルティ|Lv.83|ワールドボス（20:00）|フィールド固定位置|#8E44AD'
  'ウスルパトル|Lv.107|ワールドボス（20:00）|フィールド固定位置|#E74C3C'
)
...
# --- ゲヘナボス ---
post "$API/bosses" '{"name":"ゲヘナボス ★1","location":"ゲヘナ 全区域","description":"比較的弱め。13:00/17:00/21:00に全区域で出現。Lv52+","respawn_minutes":0,"color":"#E67E22","enabled":1}'
...
post "$API/bosses" '{"name":"ゲヘナボス ★3","location":"ゲヘナ 第2区域","description":"非常に強力。土曜22:00限定。英雄スキル等の希少報酬。Lv64+","respawn_minutes":0,"color":"#C0392B","enabled":1}'

# --- イベントボス バルドゥン（レッドムーンフェスタ） ---
post "$API/bosses" '{"name":"バルドゥン","location":"イベントボス（レッドムーンフェスタ）","description":"毎日11:50/19:50出現（WB10分前）。5分間ダメージ競争。イベント期間: ~2026/9/16","respawn_minutes":0,"color":"#922B21","enabled":1}'
